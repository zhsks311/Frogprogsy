...
export const PROVIDER_REGISTRY: readonly ProviderRegistryEntry[] = [
  ...
  },
  {
    ...
    authKind: "oauth",
    oauthId: "kiro",
    note: "Import a session through the official Kiro CLI",
    models: KIRO_MODELS,
    ...
    modelCapabilities: Object.fromEntries(
      KIRO_MODELS.map(id => [id, { input: id.startsWith("claude-") || id.startsWith("gpt-") ? ["text", "image"] : ["text"] } satisfies FrogModelCapabilities]),
    ),
    officialModelSources: [
