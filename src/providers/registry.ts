...
const KIMI_MOONSHOT_LOCKED_PARAMETER_MODELS = ["kimi-k3", ...KIMI_LOCKED_PARAMETER_MODELS];
...
const UMANS_TEXT_ONLY_MODELS = ["umans-glm-5.2", "umans-deepseek-v4-flash-0731"];
const UMANS_MODEL_CONTEXT_WINDOWS: Record<string, number> = {
  "umans-kimi-k3": 1_000_000,
  "umans-coder": 262_144,
  "umans-kimi-k2.7": 262_144,
  "umans-glm-5.2": 405_504,
  "umans-deepseek-v4-flash-0731": 1_000_000,
  "umans-flash": 262_144,
};
...
export const PROVIDER_REGISTRY: readonly ProviderRegistryEntry[] = [
  ...
  { id: "firepass", label: "Fire Pass (Fireworks Kimi)", baseUrl: "https://api.fireworks.ai/inference/v1", adapter: "openai-chat", authKind: "key", dashboardUrl: "https://fireworks.ai/account/api-keys" },
  {
    ...
    models: ["kimi-k3", "kimi-k2.7-code", "kimi-k2.7-code-highspeed", "kimi-k2.6", "kimi-k2.5", "kimi-k2-0905-preview"],
    modelContextWindows: { "kimi-k3": 1_000_000 },
    noReasoningModels: KIMI_THINKING_MODELS,
    modelReasoningEfforts: {
      "kimi-k3": KIMI_K3_REASONING_EFFORTS,
      ...Object.fromEntries(KIMI_THINKING_MODELS.map(id => [id, []])),
    },
    modelReasoningEffortMap: { "kimi-k3": XHIGH_TO_MAX_REASONING_MAP },
    noTemperatureModels: KIMI_MOONSHOT_LOCKED_PARAMETER_MODELS,
    noTopPModels: KIMI_MOONSHOT_LOCKED_PARAMETER_MODELS,
    noPenaltyModels: KIMI_MOONSHOT_LOCKED_PARAMETER_MODELS,
    autoToolChoiceOnlyModels: ["kimi-k2.7-code", "kimi-k2.7-code-highspeed"],
    preserveReasoningContentModels: ["kimi-k3", ...KIMI_THINKING_MODELS],
  },
  ...
  { id: "venice", label: "Venice", baseUrl: "https://api.venice.ai/api/v1", adapter: "openai-chat", authKind: "key", dashboardUrl: "https://venice.ai/settings/api" },
  {
    ...
    models: ["glm-5.2", "glm-5.2[1m]", "glm-5.1", "glm-5", "glm-4.7", "glm-4.6"],
    modelContextWindows: { "glm-5.2[1m]": 1_000_000 },
